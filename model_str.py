"""
fui contratado por um novo serviço de streaming de filmes e seriese minha 
primeiro tarefa e projetar o banco de dados.

Diferente dos sistemas tradicionais, a empresa quer focar nos relacionamentos
para criar um sistema de recomendaçâo poderoso.

Projeto:
 Modele e crie um pequeno grafo de conhecimento para este serviço. 
 
 O modelo deve incluir:
 -Entidades(Nós): User, Movies, Series, Genre, Actor, Director.
 -Conexoes(Relacionamentos):WATCHED(com propriedade rating), ACTED_IN, 
 DIRECTED, IN_GENRE.
 
 Entrega:
  - Um diagrama do modelo de grafo.
  -Um script Cypher que cria constraints para os nós(ex: UNIQUE para IDS)
  e popula o banco com pelo menos 10 usuários, 10 filmes/séries e seus 
  respctitivos relacionamentos.
  
  ferramentas:
   -Use o neo4j python para conectar criar o grafo.
   - 
   
fazer tudo em python. 
...
# ======= Configuraçoes de Conexão ========

URI = "neo4j://127.0.0.1:7687"   
USER = "neo4j"
PASSWORD = "12161819"  # substitua pela senha do seu banco
...
def create_constraints(tx):
    tx.run(create_constraints_query)
